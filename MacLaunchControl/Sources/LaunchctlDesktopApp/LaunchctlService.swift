...
struct LaunchctlService {
    ...
    func createOrUpdateAgent(input: ScheduleInput) throws {
        ...
        var plist: [String: Any] = [
            ...
            "StartCalendarInterval": buildCalendar(from: input),
    ...
    func updateTimer(at plistPath: String, input: ScheduleInput) throws {
        ...
        updated["StartCalendarInterval"] = buildCalendar(from: input)
        updated.removeValue(forKey: "StartInterval")
    ...
    private func timerInputParts(from plist: [String: Any]) -> (hour: Int?, minute: Int?, weekdays: Set<Int>) {
        ...
        return (first["Hour"], first["Minute"], weekdays)
    }
